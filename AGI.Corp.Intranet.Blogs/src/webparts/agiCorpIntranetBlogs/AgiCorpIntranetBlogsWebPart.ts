...
import * as strings from 'AgiCorpIntranetBlogsWebPartStrings';
import AgiCorpIntranetBlogs from './components/AgiCorpIntranetBlogs';
import { IAgiCorpIntranetBlogsProps } from './components/IAgiCorpIntranetBlogsProps';
import { SPComponentLoader } from '@microsoft/sp-loader';

export interface IAgiCorpIntranetBlogsWebPartProps {
  description: string;
}

export default class AgiCorpIntranetBlogsWebPart extends BaseClientSideWebPart<IAgiCorpIntranetBlogsWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IAgiCorpIntranetBlogsProps> = React.createElement(
      AgiCorpIntranetBlogs,
      {
