...
export const PolicyDetail = (props: IPolicyDetail): JSX.Element => {
    ...
    const [excludePrint, setExcludePrint] = useState(false);
    ...
    const handlePrint = useReactToPrint({
        ...
        onBeforeGetContent: () => {
            return new Promise((resolve, reject) => {
                resolve(setExcludePrint(true));
            });
        },
        onAfterPrint: () => {
            return new Promise((resolve, reject) => {
                resolve(setExcludePrint(false));
            });
    ...
    return (<>
        <div className="content-wrapper" ref={componentRef}>
            <div className="privacy-terms-section">
                <div className="container terms-privacy-wrapper" style={{ border: `${excludePrint ? 'none' : ''}` }}>
                    <div className="row">
