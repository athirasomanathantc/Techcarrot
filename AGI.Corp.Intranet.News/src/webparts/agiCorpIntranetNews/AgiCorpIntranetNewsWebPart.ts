...
import * as strings from 'AgiCorpIntranetNewsWebPartStrings';
import AgiCorpIntranetNews from './components/AgiCorpIntranetNews';
import { IAgiCorpIntranetNewsProps } from './components/IAgiCorpIntranetNewsProps';

export interface IAgiCorpIntranetNewsWebPartProps {
  description: string;
}
import { SPComponentLoader } from '@microsoft/sp-loader';

export default class AgiCorpIntranetNewsWebPart extends BaseClientSideWebPart<IAgiCorpIntranetNewsWebPartProps> {
