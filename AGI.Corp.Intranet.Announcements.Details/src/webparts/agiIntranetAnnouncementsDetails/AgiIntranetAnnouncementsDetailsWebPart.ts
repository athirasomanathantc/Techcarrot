...
export default class AgiIntranetAnnouncementsDetailsWebPart extends BaseClientSideWebPart<IAgiIntranetAnnouncementsDetailsWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IAgiIntranetAnnouncementsDetailsProps> = React.createElement(
      AgiIntranetAnnouncementsDetails,
      {
