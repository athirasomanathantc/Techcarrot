...
import * as strings from 'AgiIntranetEventsWebPartStrings';
import AgiIntranetEvents from './components/AgiIntranetEvents';
import { IAgiIntranetEventsProps } from './components/IAgiIntranetEventsProps';
import { SPComponentLoader } from '@microsoft/sp-loader';
export interface IAgiIntranetEventsWebPartProps {
  description: string;
}

export default class AgiIntranetEventsWebPart extends BaseClientSideWebPart<IAgiIntranetEventsWebPartProps> {
 ...
 SPComponentLoader.loadCss(`${this.context.pageContext.web.absoluteUrl}/Assets/css/Events.css?${randomNumber}`);
  ...
  public render(): void {
    const element: React.ReactElement<IAgiIntranetEventsProps> = React.createElement(
      AgiIntranetEvents,
      {
