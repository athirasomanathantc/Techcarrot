...
import styles from './AgiIntBusFuncsService.module.scss';
import { IAgiIntBusFuncsServiceProps } from './IAgiIntBusFuncsServiceProps';
import { escape } from '@microsoft/sp-lodash-subset';
import { sp } from '@pnp/sp/presets/all';
import { IAgiIntBusFuncsServiceState } from './IAgiIntBusFuncsServiceState';
...
export default class AgiIntBusFuncsService extends React.Component<IAgiIntBusFuncsServiceProps, IAgiIntBusFuncsServiceState> {



  constructor(props: IAgiIntBusFuncsServiceProps) {
    super(props);
    sp.setup({
  ...
  public render(): React.ReactElement<IAgiIntBusFuncsServiceProps> {
    return (
      <div className={styles.agiIntBusFuncsService}>
                  ...
                  <div className="carousel-inner w-100">
                    {
                      this.state.contentItems.map((items, i) => {
                        const navURL = items.NavigationUrl.Url;
