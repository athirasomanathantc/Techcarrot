    ...
    return (
        <div className="card news-card h-100">
            ...
            <div className="card-body d-flex flex-column">
                ...
                <a href={`${siteUrl}/SitePages/News/Announcements/Announcement Details.aspx?announcementID=${announcement.ID}&env=WebView`} className="btn news-read-more mt-auto  align-self-start">Read more</a>
            </div>
        </div>
    )
}
