...
export interface IAgiIntranetAnnouncementsListingWebPartProps {
  description: string;
}

export default class AgiIntranetAnnouncementsListingWebPart extends BaseClientSideWebPart<IAgiIntranetAnnouncementsListingWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IAgiIntranetAnnouncementsListingProps> = React.createElement(
      AgiIntranetAnnouncementsListing,
      {
